...
function ScrollView(props){
  ...
  function addScrollListener(){
    document.querySelector("main").addEventListener("scroll", onScrollHandler, false)
  ...
  function onScrollHandler(event) {
    console.log(event)
    if(canMove){
      let mainScrollTop = document.querySelector("main").scrollTop
      mainScrollTop>scrollTop ? changeActiveNum(true) : changeActiveNum()
      document.querySelector("main").scrollTo(0,0)
      scrollTop = mainScrollTop
    }
    // console.log(document.querySelector("main").scrollTop)
    // console.log(window.scrollY)
    // console.log("1 "+scrollTop,window.scrollY>scrollTop)
    // window.scrollY>scrollTop ? changeActiveNum(true) : changeActiveNum()
